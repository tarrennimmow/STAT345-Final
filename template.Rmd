...
drawn_card<-sample(1:16, 1, replace = F)
print(CommunityChestCards[drawn_card,])
CommunityChestCards<<-CommunityChestCards[-drawn_card,]
if(nrow(CommunityChestCards=2))
}
