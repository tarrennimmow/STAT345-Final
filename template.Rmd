...
move_player <- function() {
  ...
  new_location <- player_stats[[player_turn, "Location"]] + total_sum  # moves the player to the new location
  ...
  current_class <- current_square$Class
   ...
   if (current_class == "Railroad Tile") {
    print("Railroad Tile")
    ...
    print("Income Tax")
  } else if (current_class == "Go to Jail Tile") {
...
move_player <- function() {
  ...
  if (new_location > 40) {#checks if the player passes 40th square
    ...
    print( passed_Go)#announces player passed go
  }#does it stop then or does it keep going?
  ...
  player_stats[player_turn, "Location"] <<- new_location#moves player to the correct space after go
  new_location<<-new_location
  
  
  
 return(list(player_stats=player_stats, new_location=new_location))
